...
Important: This script only works for recordings that contains, whstim, astim and nonstim.
...
for m, d in enumerate(imaging_days):
    ...
    for n in range(TrialNumber):
        ...
        if FAChunk[n] == 1:        
            Half_FA = 0.5/(sum((ChunkPer == 5)) + sum((ChunkPer == 4)) )   # This part is very questionable.
            FA = 1-Half_FA            
        elif FAChunk[n] == 0:
